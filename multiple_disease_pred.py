...
parkinsons_model = pickle.load(open('/Users/rudrashah/Aaryan/Diseases_Pred_System/parkinsons_model.sav', 'rb'))

breast_cancer_model = pickle.load(open('/Users/rudrashah/Aaryan/Diseases_Pred_System/breast_cancer_model.sav', 'rb'))

diabetes_model = pickle.load(open('/Users/rudrashah/Aaryan/Diseases_Pred_System/diabetes_model.sav', 'rb'))

heart_disease_model = pickle.load(open('/Users/rudrashah/Aaryan/Diseases_Pred_System/heart_disease_model.sav','rb'))
...
with st.sidebar:
    ...
    selected = option_menu('Disease Prediction System',
                          ...
                          icons=['heart','activity','person','cancer'],
                          default_index=0)
...
if (selected == 'Breast Cancer Prediction'):
    ...
    if st.button('Breast Cancer Test Result'):
        cancer_prediction = breast_cancer_model.predict([[radius_mean, texture_mean, perimeter_mean, area_mean, smoothness_mean, compactness_mean, concavity_mean,concave_points_mean,
